...
D3XZSpriteRenderModel::~D3XZSpriteRenderModel() {
}

void
D3XZSpriteRenderModel::render(RenderEngine *re) {
    glPushMatrix();
...
*/
    ...
    glBegin(GL_QUADS);
        ...
        glVertex3f(m_rcDrawArea.w, 0.f, m_rcDrawArea.h);

        //Bottom-left vertex (corner)
        glTexCoord2f(fTexLeft, fTexBottom);
        glVertex3f(0.f, 0.f, m_rcDrawArea.h);
    glEnd();
    //glDepthMask(GL_TRUE);
    glPopMatrix();
}
